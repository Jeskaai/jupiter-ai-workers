...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--test", action="store_true", help="Ejecuta una prueba funcional local sin requerir camara")
...
def main() -> None:
    ...
    if args.test:
        import numpy as np
        print("Ejecutando prueba funcional local...")
        ...
        annotated_frame, people = detector.process_frame(dummy_frame, timestamp_ms=0)
        print(f"Prueba completada exitosamente. Se utilizaron las configuraciones de {detector.backend}.")
        print(f"Resultado procesado sin errores. Personas encontradas: {len(people)}")
        return
